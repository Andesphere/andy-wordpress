...
4. In the Andy App open your Agent, go to Channels and click Configure on the Website Widget card. In the code snippet that opens, copy the value of `embedId` from `<AndyChat embedId="..." />`. That is the embed id.
